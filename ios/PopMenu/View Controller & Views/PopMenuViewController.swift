...
final public class PopMenuViewController: UIViewController {
    ...
    public convenience init(
        ...
        appearance: PopMenuAppearance? = nil
    ) {
        self.init(nibName: nil, bundle: nil)
        
        self.sourceView = sourceView
        self.actions = actions
        self.absoluteSourceFrame = sourceRect
...
extension PopMenuViewController {
    ...
    fileprivate func calculateContentOrigin(with size: CGSize) -> CGPoint {
        ...
        var y = sourceFrame.origin.y
        switch appearance.popMenuGravityBottom {
        ...
        var desiredOrigin = CGPoint(x: sourceFrame.origin.x - offsetX, y: y)
    ...
    fileprivate func calculateContentWidth() -> CGFloat {
        ...
        return min(max(250, contentFitWidth),maxContentWidth)
    }
